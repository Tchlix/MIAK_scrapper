...
public class ScrapperTest {
    ...
    public Object[][] dataProv() {
        return new Object[][]{
                ...
                {"x SET bercik[2][1 + 3];", String.format("x = bercik[2][1 + 3]%n")},
                {"x SET CHILDREN(bercik[0]);", String.format("x = bercik[0].children%n")},
                ...
                {"companies[i] SET CHILDREN(CHILDREN(companies[i])[0])[1] GET ATTRIBUTE \"href\";", String.format("companies[i] = companies[i].children[0].children[1].getAttribute(\"href\")%n")},
